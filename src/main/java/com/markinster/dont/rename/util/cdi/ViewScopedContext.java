package com.markinster.dont.rename.util.cdi;
 ...
 * 
 * @author Steve Taylor, Marcos Soares(markinster@gmail.com) 
 * 
 * By Markinter
 * adicionado @SuppressWarnings({ "rawtypes", "unchecked" })<br>
 * ao metodo <b>processEvent<b><br>
 * e @SuppressWarnings("unchecked") ao médodo <b>get</b>
 * 
 */
